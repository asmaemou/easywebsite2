  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="flex flex-wrap justify-center items-center mt-8 w-3/4 gap-20">
        <div className="text-center bg-gray-200 p-2 rounded-lg w-full md:w-1/2 lg:w-1/3 xl:w-1/4 mb-4 md:mb-0 mr-2 md:mr-4">
      ...
      <div className="bg-gray-200 p-2 rounded-lg w-full md:w-1/2 lg:w-1/3 xl:w-1/4 mt-4 flex justify-center items-center bg-yellow-500">
          <a
